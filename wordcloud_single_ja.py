...
if not os.path.exists("single_ja_wordcloud"):
    os.makedirs("single_ja_wordcloud")

files = glob.glob("./single_ja_text/*")
...
for file in files:
    ...
    wordcloud.to_file('./single_ja_wordcloud/wordcloud_ja_'+name+'_.png')